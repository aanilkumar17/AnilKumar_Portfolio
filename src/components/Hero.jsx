  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      particles.forEach((p) => {
        ...
        ctx.fillStyle = `rgba(108,99,255,${p.a * 0.4})`;
        ctx.fill();
      });
      ...
      for (let i = 0; i < particles.length; i++) {
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (d < 120) {
            ...
            ctx.strokeStyle = `rgba(108,99,255,${(1 - d / 120) * 0.12})`;
            ctx.lineWidth = 0.5;
            ctx.stroke();
          }
        }
      ...
      <div className="hero-content container">
        <div className="hero-left">
          ...
          <h1 className="hero-title">
            ...
            <span className="hero-name gradient-text">{greeting.title}</span>
          </h1>
          <p className="hero-sub">{greeting.subTitle}</p>
          <div className="hero-cta">
            <a href={greeting.resumeLink} target="_blank" rel="noreferrer" className="btn btn-primary">
              View Resume ↗
            </a>
